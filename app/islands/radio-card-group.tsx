import { type JSX, useEffect, useId, useState } from "hono/jsx";
import {
	GroupContent,
	type RadioCardGroupItem,
	Root,
	type RootProps,
} from "../components/ui/radio-card-group-primitive";

interface RadioCardGroupIslandProps extends RootProps {
	items?: (string | RadioCardGroupItem)[];
	label?: string | JSX.Element;
}

function RadioCardGroupIsland(props: RadioCardGroupIslandProps) {
	const {
		items,
		label,
		children,
	...
	return (
		<Root {...rest} id={id} value={value} data-hydrated="true">
...
export type { RadioCardGroupIslandProps };
export default RadioCardGroupIsland;
