...
const PointSchemaModule = {
	...
	assertEquals: typia.createAssertEquals<Point>(),
	validateEquals: typia.createValidateEquals<Point>(),
	assertGuardEquals: typia.createAssertGuardEquals<Point>(),
	assertGuardValidate: typia.createAssertGuard<Point>(),
