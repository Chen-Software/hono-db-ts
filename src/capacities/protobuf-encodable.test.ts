...
const pingModule: SchemaModule<Ping> = {
	...
	"assert-equals": typia.createAssertEquals<Ping>(),
	"validate-equals": typia.createValidateEquals<Ping>(),
	"assert-guard-equals": typia.createAssertGuardEquals<Ping>(),
	"assert-guard-validate": typia.createAssertGuard<Ping>(),
